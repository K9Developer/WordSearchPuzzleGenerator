...
def save_configuration(variables_info):
    ...
    save_filename = popup_get_file("Save as", file_types=(("CONFIG", '.swpconfig'), ("CONFIG", '.cwconfig')),
...
def load_configuration(window):
    """
    Loads a .cwconfig file and load the settings.
    ...
    save_filename = popup_get_file(
        "Load configuration file", file_types=(("CONFIG", '.cwconfig'), ("CONFIG", '.cwconfig')), no_window=True
    )
...
def setup_layout():
    ...
    global layout1
    layout1 = [[Column(column4, element_justification='c', vertical_scroll_only=True, background_color='#404040',
                       key='-COL4-'),
                pin(Column(column1, element_justification='c', vertical_scroll_only=True, background_color='#404040',
                           key='-COL1-', visible=False), background_color='#404040'),
                pin(Column(column2, element_justification='c', vertical_scroll_only=True, background_color='#404040',
                           key='-COL2-', visible=False), background_color='#404040'),
                pin(Column(column3, element_justification='c', vertical_scroll_only=True, background_color='#404040',
                           key='-COL3-', visible=False), background_color='#404040')]]
...
def window_loop():
    ...
    while True:
        ...
        elif len(''.join(words)) > 60:
            window['-INPUT1STR-'].ParentRowFrame.config(background='red')
            window['-INPUT1STR-'].set_tooltip("You have reached the max character limit (50)")
            checks[0] = False
